...
<head>
  ...
  <style>
    body {font-family: Arial, sans-serif; margin:0; padding:0; background:#f4f4f4; scroll-behavior: smooth;}
    header {background: url('https://upload.wikimedia.org/wikipedia/commons/6/60/Old_Faithful_erupting.jpg') no-repeat center center/cover; color:white; height:60vh; display:flex; flex-direction:column; justify-content:center; align-items:center; text-align:center;}
    nav {background:#333; padding:1em; position:sticky; top:0; z-index:100;}
    nav a {color:white; margin:0 1em; text-decoration:none; font-weight:bold;}
    section {padding:2em; max-width:1200px; margin:auto;}
    h1,h2,h3 {color:#333;}
    .attraction, .avoid {margin-bottom:1.5em;}
    .gallery img {width:100%; max-width:400px; margin:1em; border-radius:8px;}
...
<img src="https://travel.usnews.com/images/Photography_by_Deb_Snelsonnature-hot-spring-park.jpg" alt="Admire the colors of the Grand Prismatic Spring"/>
 <img src="https://waterfallrecord.com/wp-content/uploads/2019/06/dsc_1169.jpg" alt="Lower Yellowstone Falls, Wyoming | The Waterfall Record"/><img src="https://d.newsweek.com/en/full/2379240/yellowstone-lake.jpg" alt="Yellowstone Lake Ice Cover Unchanged—but &#39;Tipping Point&#39; Is ..."/><img src="https://www.tetonscience.org/wp-content/uploads/2020/09/SE-Sunset-in-Lamar-scaled-1.jpg" alt="Battle of the Yellowstone Wildlife Valleys: Hayden Valley vs ..."/>
